...
A complete sample run is available in `docs/examples/`:

- [`sample_draft_assessment.md`](docs/examples/sample_draft_assessment.md) — full cited compliance assessment generated by the agent for AC-2, AC-3, AC-6, AC-17
- [`sample_governance_decision.json`](docs/examples/sample_governance_decision.json) — runtime governance decision record from the same run
...
| | |
|---|---|
| ![UI Initial State](docs/screenshots/screenshot-01-ui-initial-state.png) | ![Awaiting Approval](docs/screenshots/screenshot-02-awaiting-approval.png) |
| Streamlit UI — run configuration | All nodes complete — draft ready for review |
